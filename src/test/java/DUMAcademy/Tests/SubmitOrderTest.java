...
public class SubmitOrderTest extends BaseTest{
	...
	//verify Zara Coat 3 is displayed on the Order History page
	...
	{
		return new Object[][] {{"dhananjay1.more@gmail.com","India@2025","ZARA COAT 3"},{"dhananjay1.more@gmail.com","India@2025","ADIDAS ORIGINAL"}};
	}
	...
	public Object[][] getData1() 
	{
		...
		map.put("email", "dhananjay1.more@gmail.com");
		map.put("password", "India@2025");
		map.put("product", "ZARA COAT 3");
		
		HashMap<String, String> map1 =new HashMap<String, String>();
		map1.put("email", "dhananjay1.more@gmail.com");
		map1.put("password", "India@2025");
	...
	{
		List<HashMap<String, String>> data=getJsonDataToMap(System.getProperty("user.dir")+"\\src\\test\\java\\DUMAcademy\\data\\PurchaseOrder.json");
