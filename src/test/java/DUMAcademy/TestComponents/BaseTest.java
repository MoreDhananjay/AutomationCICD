package DUMAcademy.TestComponents;
...
public class BaseTest {
	...
	public WebDriver initilizeDriver() throws IOException 
	{
		...
		FileInputStream fis= new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\java\\DUMAcademy\\resources\\GlobalData.properties");
		prop.load(fis);
